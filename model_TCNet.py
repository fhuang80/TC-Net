...
class Latentfeature(nn.Module):
    def __init__(self,num_scales,each_scales_size,point_scales_list):
        ...
        self.SA = SA_Layer(channels=1920, R=1)
    ...
    def forward(self,x):
        ...
        latentfeature = self.SA(latentfeature)
...
#        
        ...
        self.SA1 = SA_Layer(channels=64, R=1)
        self.SA2 = SA_Layer(channels=6, R=1)
        self.SA3 = SA_Layer(channels=12, R=1)
